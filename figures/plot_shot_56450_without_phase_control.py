...
pulse = 56450  # phase control is OK
...
with plt.style.context('seaborn-paper'):
    ...
    ax[0].plot(t_Q1, P_Q1, lw=2, color='C1', label='Coupled Power (Q1)')
    ...
    ax[2].plot(t_Rc_Q2, Rc_Q2, label='$R_c$ (Q1)', lw=2, color='C1')
    ax[2].set_ylim(0, 1.3)
    ax[2].set_ylabel('[$\Omega$]', fontsize=12)
    ax[2].legend(fontsize=10)
    
    ax[3].plot(t_phaseQ1, phaseQ1, lw=2, color='C1', label='Toroidal Phase (Q1)')
