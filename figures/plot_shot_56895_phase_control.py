...
pulse = 56895  # phase control is OK
...
phaseQ1, t_phaseQ1 = get_sig(pulse, signals['IC_Phase_Q1'], do_smooth=False) 
phaseQ2, t_phaseQ2 = get_sig(pulse, signals['IC_Phase_Q2'], do_smooth=False) 
# phaseQ4, t_phaseQ4 = get_sig(pulse, signals['IC_Phase_Q4'], do_smooth=False)

#%% 

with plt.style.context('seaborn-paper'):
    fig, ax = plt.subplots(4, 1, sharex=True)
    ax[0].plot(t_Q1, P_Q1, lw=2, color='C0', label='Coupled Power (Q1)')
